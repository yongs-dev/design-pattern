...
/**
 * <b>전략 패턴 (Strategy Pattern)</b><br>
 * 실행(런타임) 중에 알고리즘 전략을 선택하여 객체 동작을 실시간으로 바꾸도록 할 수 있는 행위 디자인 패턴으로 '전략'이란 일종의 알고리즘이 될 수도 있으며 기능이나 동작이 될 수도 있는 특정한 목표를 수행하기 위한 행동 계획을 말한다.<br>
 * 즉 어떤 일을 수행하는 알고리즘이 여러 가지 일 때 동작들을 미리 전략으로 정의함으로써 손쉽게 전략을 교체할 수 있는, 알고리즘 변형이 빈번하게 필요한 경우에 적합한 패턴이다.<br>
 ...
 * <br><hr><br>
 * <b>Strategy VS Template Method</b><br>
 * 패턴 유사점<br>
 * 1. 알고리즘을 때에 따라 적용한다는 컨셉<br>
 * 2. 개방 폐쇄 원칙(OCP)을 충족하고 코드를 변경하지 않고 소프트웨어 모듈을 쉽게 확장할 수 있도록 하는 데 사용할 수 있다.<br>
 * <br>
 * 패턴 차이점<br>
